...
/**
 * Test case for class \TYPO3\Z3Shop\Domain\Model\ProductCart.
 *
 * @version $Id$
 ...
 */
class ProductCartTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	/**
	 * @var \TYPO3\Z3Shop\Domain\Model\ProductCart
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new \TYPO3\Z3Shop\Domain\Model\ProductCart();
	}
	...
	public function setAmountForStringSetsAmount() { 
		$this->fixture->setAmount('Conceived at T3CON10');
	 ...
	 * @test
	 */
	public function getCartReturnsInitialValueForCart() { }

	/**
	 * @test
	 */
	public function setCartForCartSetsCart() { }
