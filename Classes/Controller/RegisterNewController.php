 ...
 *
 */
class RegisterNewController extends \TYPO3\Z3Shop\Controller\RegisterAbstractController {
	...
	public function createAction(\In2\Femanager\Domain\Model\User $user) {
		...
		\In2\Femanager\Utility\Div::hashPassword($user, $this->settings['new']['misc']['passwordSave']);
