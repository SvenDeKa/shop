...
class Calculate {
	...
	/**
	 * 
	 * @param \TYPO3\CMS\Z3Shop\Domain\Model\Cart $cart
	 * @return int
	 */
	public function shippingWeight(\TYPO3\CMS\Z3Shop\Domain\Model\Cart $cart){
//		$products = $cart->getProducts();
	...
	/**
	 * @Todo: configurable ShippingTypes
	 * @param type $shippingType
	 * @param type $weight
	 * @return int
	 */
	public function shippingFee($shippingType, $weight){
