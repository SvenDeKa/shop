 ...
 */
$ajax = \TYPO3\CMS\Core\Utility\GeneralUtility::_GP('tx_z3shop_cart') ;
...
$request->setControllerActionName($ajax['action'].'JSON');
$request->setArguments( $ajax );
//\TYPO3\CMS\Extbase\Utility\DebuggerUtility::var_dump($request, 'AjaxDispatcher -> $request');
